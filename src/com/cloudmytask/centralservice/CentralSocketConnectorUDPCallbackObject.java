...
public class CentralSocketConnectorUDPCallbackObject implements CallbackInterface {
	private DatagramSocket socket;
	private InetAddress addr;
	private int port;
	
	public CentralSocketConnectorUDPCallbackObject(DatagramSocket socket, InetAddress addr, int port) {
		this.socket = socket;
		this.addr = addr;
		this.port = port;
	}
